...
public class ProcessDirectory {
    ...
    public final static ProcessDirectory USR2_PAGE = new ProcessDirectory(DIRECTORY.USR2);
    public final static ProcessDirectory USR3_PAGE = new ProcessDirectory(DIRECTORY.USR3);
